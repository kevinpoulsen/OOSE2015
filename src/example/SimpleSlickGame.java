...
public class SimpleSlickGame extends BasicGame
{
	...
	public void update(GameContainer gc, int i) throws SlickException {
		...
		if(padOneBool == true && Player.angleState == 0 && Player.yCond < 15){
			score+=Player.fuel/ GameMaster.timer;
			gameState = 3;
			
		}
		// Same win condition, another landing pad.
		if(padTwoBool == true && Player.angleState == 0 && Player.yCond < 15){
			score+=Player.fuel/ GameMaster.timer;
			gameState = 3;
		}
		// Same win condition, last landing pad.
		if(padThreeBool == true && Player.angleState == 0 && Player.yCond < 15){
			score+=Player.fuel/ GameMaster.timer;
			gameState = 3;
		}
